...
class BertSelfAttention(nn.Module):
    ...
    def forward(self, hidden_states, attention_mask):
        ...
        attention_scores = attention_scores / math.sqrt(self.attention_head_size)  #[B,num_attention_heads,q_len, k_len]
        # Apply the attention mask is (precomputed for all layers in BertModel forward() function)
        attention_scores = attention_scores + attention_mask  #attention_mask must [B,1,1,k_len] OR [B,1,q_len,K_LEN]
